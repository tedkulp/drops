# The drops CLI contract

Every verb this repository builds, and what a reader observes from it. This file
is the contract: **a verb that changes shape without this file changing is a
defect.** It describes the product, not this repository's own process — for where
issues for *this* repo live, see [docs/agents/issue-tracker.md](agents/issue-tracker.md).
